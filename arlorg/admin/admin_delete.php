...
<head>
    ...
    <title>Admin | Delete Resources</title>
    <style>
        body {
    ...
    <script>
        function confirmDelete(RID) {
            ...
            if (confirmDelete) {
                window.location.href = 'admin_confirm.php?resource_id=' + RID + '&action=delete';
            } else {
                return false;
            }
        }
    ...
    <div class="container">
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<input type='button' class='delete-button' value='Delete' onclick='confirmDelete(" . $row['RID'] . ")'>";
                echo "</div>";
            }
        } else {
