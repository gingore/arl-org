...
$categories = array(
    "domestic violence shelters" => "Domestic Violence Shelters",
...
<head>
    ...
    <title>ArlOrg | Safety Needs</title>
...
<body>
    ...
    <div class="container">
        <div class="hero" style="display: flex; justify-content: center; align-items: center; min-height: 10vh;">
            <div class="hero-text">
                <h1 class="title" style="margin: 0;">Safety Needs</h1>
            </div>
        </div>
        ...
        <div class="resource-container">
            <div class="resource-card-container">
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    echo "<p>No safety resources found.</p>";
                }
                ?>
            </div>
        </div>
