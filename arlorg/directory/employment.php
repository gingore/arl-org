...
$categories = array(
    ...
    "employment search engines" => "Employment Search Engines",
...
$sql .= " AND r.CID != (SELECT CID FROM ResourcesCatg WHERE CatgName = 'Housing')";
$sql .= " AND r.CID != (SELECT CID FROM ResourcesCatg WHERE CatgName = 'Safety Needs')";
...
<body>
    ...
    <div class="container">
        <div class="hero" style="display: flex; justify-content: center; align-items: center; min-height: 10vh;">
            <div class="hero-text">
                <h1 class="title" style="margin: 0;">Employment</h1>
            </div>
        </div>
        ...
        <div class="resource-container">
            <div class="resource-card-container">
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    echo "<p>No employment resources found.</p>";
                }
                ?>
            </div>
        </div>
